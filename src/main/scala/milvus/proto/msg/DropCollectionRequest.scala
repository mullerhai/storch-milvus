...
@SerialVersionUID(0L)
final case class DropCollectionRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[DropCollectionRequest] {
    @transient
    ...
    def clearBase: DropCollectionRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): DropCollectionRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): DropCollectionRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): DropCollectionRequest = copy(collectionName = __v)
    def withDbID(__v: _root_.scala.Long): DropCollectionRequest = copy(dbID = __v)
    def withCollectionID(__v: _root_.scala.Long): DropCollectionRequest = copy(collectionID = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => _root_.scalapb.descriptors.PLong(dbID)
        case 5 => _root_.scalapb.descriptors.PLong(collectionID)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: DropCollectionRequest.type = msg.DropCollectionRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.msg.DropCollectionRequest])
}

object DropCollectionRequest extends scalapb.GeneratedMessageCompanion[DropCollectionRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[DropCollectionRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): DropCollectionRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[DropCollectionRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      DropCollectionRequest(
        ...
        dbID = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Long]).getOrElse(0L),
        collectionID = __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scala.Long]).getOrElse(0L)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = MsgProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = msg.MsgProto.scalaDescriptor.messages(4)
  ...
  lazy val defaultInstance = DropCollectionRequest(
  ...
  implicit class DropCollectionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, DropCollectionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, DropCollectionRequest](_l) {
  ...
  final val DBID_FIELD_NUMBER = 4
  final val COLLECTIONID_FIELD_NUMBER = 5
  def of(
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.msg.DropCollectionRequest])
}
