...
@SerialVersionUID(0L)
final case class DropPartitionRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[DropPartitionRequest] {
    @transient
    ...
    def clearBase: DropPartitionRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): DropPartitionRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): DropPartitionRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): DropPartitionRequest = copy(collectionName = __v)
    def withPartitionName(__v: _root_.scala.Predef.String): DropPartitionRequest = copy(partitionName = __v)
    def withDbID(__v: _root_.scala.Long): DropPartitionRequest = copy(dbID = __v)
    def withCollectionID(__v: _root_.scala.Long): DropPartitionRequest = copy(collectionID = __v)
    def withPartitionID(__v: _root_.scala.Long): DropPartitionRequest = copy(partitionID = __v)
    ...
    def companion: DropPartitionRequest.type = msg.DropPartitionRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.msg.DropPartitionRequest])
}

object DropPartitionRequest extends scalapb.GeneratedMessageCompanion[DropPartitionRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[DropPartitionRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): DropPartitionRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[DropPartitionRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = MsgProto.javaDescriptor.getMessageTypes().get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = msg.MsgProto.scalaDescriptor.messages(6)
  ...
  lazy val defaultInstance = DropPartitionRequest(
  ...
  implicit class DropPartitionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, DropPartitionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, DropPartitionRequest](_l) {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.msg.DropPartitionRequest])
}
