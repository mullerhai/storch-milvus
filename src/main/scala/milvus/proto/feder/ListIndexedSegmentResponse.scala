...
@SerialVersionUID(0L)
final case class ListIndexedSegmentResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ListIndexedSegmentResponse] {
    ...
    def clearStatus: ListIndexedSegmentResponse = copy(status = _root_.scala.None)
    def withStatus(__v: io.milvus.grpc.common.Status): ListIndexedSegmentResponse = copy(status = Option(__v))
    def clearSegmentIDs = copy(segmentIDs = _root_.scala.Seq.empty)
    def addSegmentIDs(__vs: _root_.scala.Long *): ListIndexedSegmentResponse = addAllSegmentIDs(__vs)
    def addAllSegmentIDs(__vs: Iterable[_root_.scala.Long]): ListIndexedSegmentResponse = copy(segmentIDs = segmentIDs ++ __vs)
    def withSegmentIDs(__v: _root_.scala.Seq[_root_.scala.Long]): ListIndexedSegmentResponse = copy(segmentIDs = __v)
    ...
    def companion: ListIndexedSegmentResponse.type = feder.ListIndexedSegmentResponse
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.feder.ListIndexedSegmentResponse])
}

object ListIndexedSegmentResponse extends scalapb.GeneratedMessageCompanion[ListIndexedSegmentResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ListIndexedSegmentResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ListIndexedSegmentResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ListIndexedSegmentResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = FederProto.javaDescriptor.getMessageTypes().get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = feder.FederProto.scalaDescriptor.messages(3)
  ...
  lazy val defaultInstance = ListIndexedSegmentResponse(
    status = _root_.scala.None,
    segmentIDs = _root_.scala.Seq.empty
  )
  implicit class ListIndexedSegmentResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ListIndexedSegmentResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ListIndexedSegmentResponse](_l) {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.feder.ListIndexedSegmentResponse])
}
