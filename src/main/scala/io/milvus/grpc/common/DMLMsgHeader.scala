...
final case class DMLMsgHeader(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[DMLMsgHeader] {
    @transient
    ...
    def clearBase: DMLMsgHeader = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): DMLMsgHeader = copy(base = Option(__v))
    def withShardName(__v: _root_.scala.Predef.String): DMLMsgHeader = copy(shardName = __v)
    ...
    def companion: io.milvus.grpc.common.DMLMsgHeader.type = io.milvus.grpc.common.DMLMsgHeader
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.common.DMLMsgHeader])
}

object DMLMsgHeader extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.common.DMLMsgHeader] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.common.DMLMsgHeader] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.common.DMLMsgHeader = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.common.DMLMsgHeader] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.common.CommonProto.javaDescriptor.getMessageTypes().get(10)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.common.CommonProto.scalaDescriptor.messages(10)
  ...
  lazy val defaultInstance = io.milvus.grpc.common.DMLMsgHeader(
    base = _root_.scala.None,
    shardName = ""
  )
  implicit class DMLMsgHeaderLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.common.DMLMsgHeader]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.common.DMLMsgHeader](_l) {
  ...
  def of(
    ...
    shardName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.common.DMLMsgHeader = _root_.io.milvus.grpc.common.DMLMsgHeader(
    base,
    shardName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.common.DMLMsgHeader])
}
