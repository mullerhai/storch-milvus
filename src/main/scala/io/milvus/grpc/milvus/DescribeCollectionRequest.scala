...
/** *
  ...
  */
@SerialVersionUID(0L)
final case class DescribeCollectionRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[DescribeCollectionRequest] {
    @transient
    ...
    def clearBase: DescribeCollectionRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): DescribeCollectionRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): DescribeCollectionRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): DescribeCollectionRequest = copy(collectionName = __v)
    def withCollectionID(__v: _root_.scala.Long): DescribeCollectionRequest = copy(collectionID = __v)
    def withTimeStamp(__v: _root_.scala.Long): DescribeCollectionRequest = copy(timeStamp = __v)
    ...
    def companion: io.milvus.grpc.milvus.DescribeCollectionRequest.type = io.milvus.grpc.milvus.DescribeCollectionRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.DescribeCollectionRequest])
}

object DescribeCollectionRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DescribeCollectionRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DescribeCollectionRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.DescribeCollectionRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.DescribeCollectionRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(14)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(14)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.DescribeCollectionRequest(
  ...
  implicit class DescribeCollectionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.DescribeCollectionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.DescribeCollectionRequest](_l) {
  ...
  final val TIME_STAMP_FIELD_NUMBER = 5
  def of(
  ...
  ): _root_.io.milvus.grpc.milvus.DescribeCollectionRequest = _root_.io.milvus.grpc.milvus.DescribeCollectionRequest(
    base,
    dbName,
    collectionName,
    collectionID,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.DescribeCollectionRequest])
}
