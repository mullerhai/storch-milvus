...
/**
  ...
  */
@SerialVersionUID(0L)
final case class HasPartitionRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[HasPartitionRequest] {
    @transient
    ...
    def clearBase: HasPartitionRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): HasPartitionRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): HasPartitionRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): HasPartitionRequest = copy(collectionName = __v)
    def withPartitionName(__v: _root_.scala.Predef.String): HasPartitionRequest = copy(partitionName = __v)
    ...
    def companion: io.milvus.grpc.milvus.HasPartitionRequest.type = io.milvus.grpc.milvus.HasPartitionRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.HasPartitionRequest])
}

object HasPartitionRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.HasPartitionRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.HasPartitionRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.HasPartitionRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.HasPartitionRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(28)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(28)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.HasPartitionRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = "",
    partitionName = ""
  )
  implicit class HasPartitionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.HasPartitionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.HasPartitionRequest](_l) {
  ...
  def of(
    ...
    collectionName: _root_.scala.Predef.String,
    partitionName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.HasPartitionRequest = _root_.io.milvus.grpc.milvus.HasPartitionRequest(
    base,
    dbName,
    collectionName,
    partitionName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.HasPartitionRequest])
}
