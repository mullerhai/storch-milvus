...
final case class UpsertRequest(
    ...
    partialUpdate: _root_.scala.Boolean = false,
    ...
    def clearBase: UpsertRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): UpsertRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): UpsertRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): UpsertRequest = copy(collectionName = __v)
    def withPartitionName(__v: _root_.scala.Predef.String): UpsertRequest = copy(partitionName = __v)
    def clearFieldsData = copy(fieldsData = _root_.scala.Seq.empty)
    def addFieldsData(__vs: io.milvus.grpc.schema.FieldData *): UpsertRequest = addAllFieldsData(__vs)
    def addAllFieldsData(__vs: Iterable[io.milvus.grpc.schema.FieldData]): UpsertRequest = copy(fieldsData = fieldsData ++ __vs)
    def withFieldsData(__v: _root_.scala.Seq[io.milvus.grpc.schema.FieldData]): UpsertRequest = copy(fieldsData = __v)
    def clearHashKeys = copy(hashKeys = _root_.scala.Seq.empty)
    def addHashKeys(__vs: _root_.scala.Int *): UpsertRequest = addAllHashKeys(__vs)
    def addAllHashKeys(__vs: Iterable[_root_.scala.Int]): UpsertRequest = copy(hashKeys = hashKeys ++ __vs)
    def withHashKeys(__v: _root_.scala.Seq[_root_.scala.Int]): UpsertRequest = copy(hashKeys = __v)
    def withNumRows(__v: _root_.scala.Int): UpsertRequest = copy(numRows = __v)
    def withSchemaTimestamp(__v: _root_.scala.Long): UpsertRequest = copy(schemaTimestamp = __v)
    def withPartialUpdate(__v: _root_.scala.Boolean): UpsertRequest = copy(partialUpdate = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 9 => _root_.scalapb.descriptors.PBoolean(partialUpdate)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: io.milvus.grpc.milvus.UpsertRequest.type = io.milvus.grpc.milvus.UpsertRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.UpsertRequest])
}

object UpsertRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.UpsertRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.UpsertRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.UpsertRequest = {
    ...
    var __partialUpdate: _root_.scala.Boolean = false
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 72 =>
          __partialUpdate = _input__.readBool()
        case tag =>
    ...
    io.milvus.grpc.milvus.UpsertRequest(
        ...
        partialUpdate = __partialUpdate,
        unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.UpsertRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      io.milvus.grpc.milvus.UpsertRequest(
        ...
        partialUpdate = __fieldsMap.get(scalaDescriptor.findFieldByNumber(9).get).map(_.as[_root_.scala.Boolean]).getOrElse(false)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(51)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(51)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.UpsertRequest(
  ...
  implicit class UpsertRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.UpsertRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.UpsertRequest](_l) {
    ...
    def partialUpdate: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Boolean] = field(_.partialUpdate)((c_, f_) => c_.copy(partialUpdate = f_))
  }
  ...
  final val PARTIAL_UPDATE_FIELD_NUMBER = 9
  def of(
    ...
    partialUpdate: _root_.scala.Boolean
  ): _root_.io.milvus.grpc.milvus.UpsertRequest = _root_.io.milvus.grpc.milvus.UpsertRequest(
    base,
    dbName,
    collectionName,
    partitionName,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.UpsertRequest])
}
