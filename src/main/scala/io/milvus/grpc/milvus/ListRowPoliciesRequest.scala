...
@SerialVersionUID(0L)
final case class ListRowPoliciesRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ListRowPoliciesRequest] {
    @transient
    ...
    def clearBase: ListRowPoliciesRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): ListRowPoliciesRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): ListRowPoliciesRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): ListRowPoliciesRequest = copy(collectionName = __v)
    ...
    def companion: io.milvus.grpc.milvus.ListRowPoliciesRequest.type = io.milvus.grpc.milvus.ListRowPoliciesRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.ListRowPoliciesRequest])
}

object ListRowPoliciesRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.ListRowPoliciesRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.ListRowPoliciesRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.ListRowPoliciesRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.ListRowPoliciesRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(198)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(198)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.ListRowPoliciesRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = ""
  )
  implicit class ListRowPoliciesRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.ListRowPoliciesRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.ListRowPoliciesRequest](_l) {
  ...
  def of(
    ...
    dbName: _root_.scala.Predef.String,
    collectionName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.ListRowPoliciesRequest = _root_.io.milvus.grpc.milvus.ListRowPoliciesRequest(
    base,
    dbName,
    collectionName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.ListRowPoliciesRequest])
}
