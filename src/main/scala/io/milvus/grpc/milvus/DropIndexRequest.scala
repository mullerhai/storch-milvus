...
/** @param base
  ...
  */
@SerialVersionUID(0L)
final case class DropIndexRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[DropIndexRequest] {
    @transient
    ...
    def clearBase: DropIndexRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): DropIndexRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): DropIndexRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): DropIndexRequest = copy(collectionName = __v)
    def withFieldName(__v: _root_.scala.Predef.String): DropIndexRequest = copy(fieldName = __v)
    def withIndexName(__v: _root_.scala.Predef.String): DropIndexRequest = copy(indexName = __v)
    ...
    def companion: io.milvus.grpc.milvus.DropIndexRequest.type = io.milvus.grpc.milvus.DropIndexRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.DropIndexRequest])
}

object DropIndexRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropIndexRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropIndexRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.DropIndexRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.DropIndexRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(48)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(48)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.DropIndexRequest(
  ...
  implicit class DropIndexRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.DropIndexRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.DropIndexRequest](_l) {
  ...
  def of(
    ...
    fieldName: _root_.scala.Predef.String,
    indexName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.DropIndexRequest = _root_.io.milvus.grpc.milvus.DropIndexRequest(
    base,
    dbName,
    collectionName,
    fieldName,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.DropIndexRequest])
}
