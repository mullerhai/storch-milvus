...
/** @param base
  ...
  */
@SerialVersionUID(0L)
final case class GetIndexStateRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetIndexStateRequest] {
    @transient
    ...
    def clearBase: GetIndexStateRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): GetIndexStateRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): GetIndexStateRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): GetIndexStateRequest = copy(collectionName = __v)
    def withFieldName(__v: _root_.scala.Predef.String): GetIndexStateRequest = copy(fieldName = __v)
    def withIndexName(__v: _root_.scala.Predef.String): GetIndexStateRequest = copy(indexName = __v)
    ...
    def companion: io.milvus.grpc.milvus.GetIndexStateRequest.type = io.milvus.grpc.milvus.GetIndexStateRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.GetIndexStateRequest])
}

object GetIndexStateRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetIndexStateRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetIndexStateRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.GetIndexStateRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.GetIndexStateRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(46)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(46)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.GetIndexStateRequest(
  ...
  implicit class GetIndexStateRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.GetIndexStateRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.GetIndexStateRequest](_l) {
  ...
  def of(
    ...
    fieldName: _root_.scala.Predef.String,
    indexName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.GetIndexStateRequest = _root_.io.milvus.grpc.milvus.GetIndexStateRequest(
    base,
    dbName,
    collectionName,
    fieldName,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.GetIndexStateRequest])
}
