...
final case class ListAliasesRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ListAliasesRequest] {
    @transient
    ...
    def clearBase: ListAliasesRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): ListAliasesRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): ListAliasesRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): ListAliasesRequest = copy(collectionName = __v)
    ...
    def companion: io.milvus.grpc.milvus.ListAliasesRequest.type = io.milvus.grpc.milvus.ListAliasesRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.ListAliasesRequest])
}

object ListAliasesRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.ListAliasesRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.ListAliasesRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.ListAliasesRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.ListAliasesRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(5)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(5)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.ListAliasesRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = ""
  )
  implicit class ListAliasesRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.ListAliasesRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.ListAliasesRequest](_l) {
  ...
  def of(
    ...
    dbName: _root_.scala.Predef.String,
    collectionName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.ListAliasesRequest = _root_.io.milvus.grpc.milvus.ListAliasesRequest(
    base,
    dbName,
    collectionName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.ListAliasesRequest])
}
