...
/** *
  ...
  */
@SerialVersionUID(0L)
final case class GetCollectionStatisticsRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetCollectionStatisticsRequest] {
    @transient
    ...
    def clearBase: GetCollectionStatisticsRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): GetCollectionStatisticsRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): GetCollectionStatisticsRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): GetCollectionStatisticsRequest = copy(collectionName = __v)
    ...
    def companion: io.milvus.grpc.milvus.GetCollectionStatisticsRequest.type = io.milvus.grpc.milvus.GetCollectionStatisticsRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.GetCollectionStatisticsRequest])
}

object GetCollectionStatisticsRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetCollectionStatisticsRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetCollectionStatisticsRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.GetCollectionStatisticsRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.GetCollectionStatisticsRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(22)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(22)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.GetCollectionStatisticsRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = ""
  )
  implicit class GetCollectionStatisticsRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.GetCollectionStatisticsRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.GetCollectionStatisticsRequest](_l) {
  ...
  def of(
    ...
    dbName: _root_.scala.Predef.String,
    collectionName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.GetCollectionStatisticsRequest = _root_.io.milvus.grpc.milvus.GetCollectionStatisticsRequest(
    base,
    dbName,
    collectionName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.GetCollectionStatisticsRequest])
}
