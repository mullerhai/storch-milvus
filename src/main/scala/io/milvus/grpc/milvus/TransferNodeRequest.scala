...
/** transfer `nodeNum` nodes from `source_resource_group` to `target_resource_group`
  */
@SerialVersionUID(0L)
final case class TransferNodeRequest(
    ...
    numNode: _root_.scala.Int = 0,
    unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[TransferNodeRequest] {
    @transient
    ...
    def clearBase: TransferNodeRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): TransferNodeRequest = copy(base = Option(__v))
    def withSourceResourceGroup(__v: _root_.scala.Predef.String): TransferNodeRequest = copy(sourceResourceGroup = __v)
    def withTargetResourceGroup(__v: _root_.scala.Predef.String): TransferNodeRequest = copy(targetResourceGroup = __v)
    def withNumNode(__v: _root_.scala.Int): TransferNodeRequest = copy(numNode = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => _root_.scalapb.descriptors.PInt(numNode)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: io.milvus.grpc.milvus.TransferNodeRequest.type = io.milvus.grpc.milvus.TransferNodeRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.TransferNodeRequest])
}

object TransferNodeRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.TransferNodeRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.TransferNodeRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.TransferNodeRequest = {
    ...
    var __numNode: _root_.scala.Int = 0
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.TransferNodeRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      io.milvus.grpc.milvus.TransferNodeRequest(
        ...
        numNode = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Int]).getOrElse(0)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(155)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(155)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.TransferNodeRequest(
    base = _root_.scala.None,
    sourceResourceGroup = "",
    targetResourceGroup = "",
    numNode = 0
  )
  implicit class TransferNodeRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.TransferNodeRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.TransferNodeRequest](_l) {
    ...
    def numNode: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] = field(_.numNode)((c_, f_) => c_.copy(numNode = f_))
  }
  ...
  final val NUM_NODE_FIELD_NUMBER = 4
  def of(
    base: _root_.scala.Option[io.milvus.grpc.common.MsgBase],
    sourceResourceGroup: _root_.scala.Predef.String,
    targetResourceGroup: _root_.scala.Predef.String,
    numNode: _root_.scala.Int
  ): _root_.io.milvus.grpc.milvus.TransferNodeRequest = _root_.io.milvus.grpc.milvus.TransferNodeRequest(
    base,
    sourceResourceGroup,
    targetResourceGroup,
    numNode
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.TransferNodeRequest])
}
