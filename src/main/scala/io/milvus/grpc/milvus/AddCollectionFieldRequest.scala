...
/** @param schema
  ...
  */
@SerialVersionUID(0L)
final case class AddCollectionFieldRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddCollectionFieldRequest] {
    @transient
    ...
    def clearBase: AddCollectionFieldRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): AddCollectionFieldRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): AddCollectionFieldRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): AddCollectionFieldRequest = copy(collectionName = __v)
    def withCollectionID(__v: _root_.scala.Long): AddCollectionFieldRequest = copy(collectionID = __v)
    def withSchema(__v: _root_.com.google.protobuf.ByteString): AddCollectionFieldRequest = copy(schema = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 5 => _root_.scalapb.descriptors.PByteString(schema)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: io.milvus.grpc.milvus.AddCollectionFieldRequest.type = io.milvus.grpc.milvus.AddCollectionFieldRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.AddCollectionFieldRequest])
}

object AddCollectionFieldRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.AddCollectionFieldRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.AddCollectionFieldRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.AddCollectionFieldRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.AddCollectionFieldRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      io.milvus.grpc.milvus.AddCollectionFieldRequest(
        ...
        schema = __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.com.google.protobuf.ByteString]).getOrElse(_root_.com.google.protobuf.ByteString.EMPTY)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(50)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(50)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.AddCollectionFieldRequest(
  ...
  implicit class AddCollectionFieldRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.AddCollectionFieldRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.AddCollectionFieldRequest](_l) {
  ...
  ): _root_.io.milvus.grpc.milvus.AddCollectionFieldRequest = _root_.io.milvus.grpc.milvus.AddCollectionFieldRequest(
    base,
    dbName,
    collectionName,
    collectionID,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.AddCollectionFieldRequest])
}
