...
@SerialVersionUID(0L)
final case class AlterAliasRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AlterAliasRequest] {
    @transient
    ...
    def clearBase: AlterAliasRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): AlterAliasRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): AlterAliasRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): AlterAliasRequest = copy(collectionName = __v)
    def withAlias(__v: _root_.scala.Predef.String): AlterAliasRequest = copy(alias = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => _root_.scalapb.descriptors.PString(alias)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: io.milvus.grpc.milvus.AlterAliasRequest.type = io.milvus.grpc.milvus.AlterAliasRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.AlterAliasRequest])
}

object AlterAliasRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.AlterAliasRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.AlterAliasRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.AlterAliasRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.AlterAliasRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      io.milvus.grpc.milvus.AlterAliasRequest(
        ...
        alias = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Predef.String]).getOrElse("")
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(2)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.AlterAliasRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = "",
    alias = ""
  )
  implicit class AlterAliasRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.AlterAliasRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.AlterAliasRequest](_l) {
  ...
  final val ALIAS_FIELD_NUMBER = 4
  def of(
    base: _root_.scala.Option[io.milvus.grpc.common.MsgBase],
    dbName: _root_.scala.Predef.String,
    collectionName: _root_.scala.Predef.String,
    alias: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.AlterAliasRequest = _root_.io.milvus.grpc.milvus.AlterAliasRequest(
    base,
    dbName,
    collectionName,
    alias
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.AlterAliasRequest])
}
