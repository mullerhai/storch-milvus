...
/** @param base
  ...
  */
@SerialVersionUID(0L)
final case class GetIndexStatisticsRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetIndexStatisticsRequest] {
    @transient
    ...
    def clearBase: GetIndexStatisticsRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): GetIndexStatisticsRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): GetIndexStatisticsRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): GetIndexStatisticsRequest = copy(collectionName = __v)
    def withIndexName(__v: _root_.scala.Predef.String): GetIndexStatisticsRequest = copy(indexName = __v)
    def withTimestamp(__v: _root_.scala.Long): GetIndexStatisticsRequest = copy(timestamp = __v)
    ...
    def companion: io.milvus.grpc.milvus.GetIndexStatisticsRequest.type = io.milvus.grpc.milvus.GetIndexStatisticsRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.GetIndexStatisticsRequest])
}

object GetIndexStatisticsRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetIndexStatisticsRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetIndexStatisticsRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.GetIndexStatisticsRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.GetIndexStatisticsRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(163)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(163)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.GetIndexStatisticsRequest(
  ...
  implicit class GetIndexStatisticsRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.GetIndexStatisticsRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.GetIndexStatisticsRequest](_l) {
  ...
  ): _root_.io.milvus.grpc.milvus.GetIndexStatisticsRequest = _root_.io.milvus.grpc.milvus.GetIndexStatisticsRequest(
    base,
    dbName,
    collectionName,
    indexName,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.GetIndexStatisticsRequest])
}
