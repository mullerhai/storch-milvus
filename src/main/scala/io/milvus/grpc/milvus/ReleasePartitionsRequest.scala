...
/**
  ...
  */
@SerialVersionUID(0L)
final case class ReleasePartitionsRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ReleasePartitionsRequest] {
    @transient
    ...
    def clearBase: ReleasePartitionsRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): ReleasePartitionsRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): ReleasePartitionsRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): ReleasePartitionsRequest = copy(collectionName = __v)
    def clearPartitionNames = copy(partitionNames = _root_.scala.Seq.empty)
    def addPartitionNames(__vs: _root_.scala.Predef.String *): ReleasePartitionsRequest = addAllPartitionNames(__vs)
    def addAllPartitionNames(__vs: Iterable[_root_.scala.Predef.String]): ReleasePartitionsRequest = copy(partitionNames = partitionNames ++ __vs)
    def withPartitionNames(__v: _root_.scala.Seq[_root_.scala.Predef.String]): ReleasePartitionsRequest = copy(partitionNames = __v)
    ...
    def companion: io.milvus.grpc.milvus.ReleasePartitionsRequest.type = io.milvus.grpc.milvus.ReleasePartitionsRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.ReleasePartitionsRequest])
}

object ReleasePartitionsRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.ReleasePartitionsRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.ReleasePartitionsRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.ReleasePartitionsRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.ReleasePartitionsRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(30)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(30)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.ReleasePartitionsRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = "",
    partitionNames = _root_.scala.Seq.empty
  )
  implicit class ReleasePartitionsRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.ReleasePartitionsRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.ReleasePartitionsRequest](_l) {
  ...
  ): _root_.io.milvus.grpc.milvus.ReleasePartitionsRequest = _root_.io.milvus.grpc.milvus.ReleasePartitionsRequest(
    base,
    dbName,
    collectionName,
    partitionNames
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.ReleasePartitionsRequest])
}
