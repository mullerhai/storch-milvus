...
/** *
  ...
  */
@SerialVersionUID(0L)
final case class ReleaseCollectionRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ReleaseCollectionRequest] {
    @transient
    ...
    def clearBase: ReleaseCollectionRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): ReleaseCollectionRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): ReleaseCollectionRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): ReleaseCollectionRequest = copy(collectionName = __v)
    ...
    def companion: io.milvus.grpc.milvus.ReleaseCollectionRequest.type = io.milvus.grpc.milvus.ReleaseCollectionRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.ReleaseCollectionRequest])
}

object ReleaseCollectionRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.ReleaseCollectionRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.ReleaseCollectionRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.ReleaseCollectionRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.ReleaseCollectionRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(19)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(19)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.ReleaseCollectionRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = ""
  )
  implicit class ReleaseCollectionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.ReleaseCollectionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.ReleaseCollectionRequest](_l) {
  ...
  def of(
    ...
    dbName: _root_.scala.Predef.String,
    collectionName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.ReleaseCollectionRequest = _root_.io.milvus.grpc.milvus.ReleaseCollectionRequest(
    base,
    dbName,
    collectionName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.ReleaseCollectionRequest])
}
