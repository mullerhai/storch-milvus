...
final case class DropPartitionRequest(
    ...
    def companion: io.milvus.grpc.milvus.DropPartitionRequest.type = io.milvus.grpc.milvus.DropPartitionRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.DropPartitionRequest])
}

object DropPartitionRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropPartitionRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropPartitionRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.DropPartitionRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.DropPartitionRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(27)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(27)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.DropPartitionRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = "",
    partitionName = ""
  )
  implicit class DropPartitionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.DropPartitionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.DropPartitionRequest](_l) {
  ...
  def of(
    ...
    collectionName: _root_.scala.Predef.String,
    partitionName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.DropPartitionRequest = _root_.io.milvus.grpc.milvus.DropPartitionRequest(
    base,
    dbName,
    collectionName,
    partitionName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.DropPartitionRequest])
}
