...
@SerialVersionUID(0L)
final case class DropAliasRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[DropAliasRequest] {
    @transient
    ...
    def clearBase: DropAliasRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): DropAliasRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): DropAliasRequest = copy(dbName = __v)
    def withAlias(__v: _root_.scala.Predef.String): DropAliasRequest = copy(alias = __v)
    ...
    def companion: io.milvus.grpc.milvus.DropAliasRequest.type = io.milvus.grpc.milvus.DropAliasRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.DropAliasRequest])
}

object DropAliasRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropAliasRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropAliasRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.DropAliasRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.DropAliasRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(1)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.DropAliasRequest(
    base = _root_.scala.None,
    dbName = "",
    alias = ""
  )
  implicit class DropAliasRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.DropAliasRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.DropAliasRequest](_l) {
  ...
  def of(
    ...
    dbName: _root_.scala.Predef.String,
    alias: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.DropAliasRequest = _root_.io.milvus.grpc.milvus.DropAliasRequest(
    base,
    dbName,
    alias
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.DropAliasRequest])
}
