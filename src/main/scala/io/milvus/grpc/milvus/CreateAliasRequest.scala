...
final case class CreateAliasRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[CreateAliasRequest] {
    @transient
    ...
    def clearBase: CreateAliasRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): CreateAliasRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): CreateAliasRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): CreateAliasRequest = copy(collectionName = __v)
    def withAlias(__v: _root_.scala.Predef.String): CreateAliasRequest = copy(alias = __v)
    ...
    def companion: io.milvus.grpc.milvus.CreateAliasRequest.type = io.milvus.grpc.milvus.CreateAliasRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.CreateAliasRequest])
}

object CreateAliasRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.CreateAliasRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.CreateAliasRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.CreateAliasRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.CreateAliasRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.CreateAliasRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = "",
    alias = ""
  )
  implicit class CreateAliasRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.CreateAliasRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.CreateAliasRequest](_l) {
  ...
  def of(
    ...
    collectionName: _root_.scala.Predef.String,
    alias: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.CreateAliasRequest = _root_.io.milvus.grpc.milvus.CreateAliasRequest(
    base,
    dbName,
    collectionName,
    alias
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.CreateAliasRequest])
}
