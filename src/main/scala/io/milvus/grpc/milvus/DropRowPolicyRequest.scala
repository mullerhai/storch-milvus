...
@SerialVersionUID(0L)
final case class DropRowPolicyRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[DropRowPolicyRequest] {
    @transient
    ...
    def clearBase: DropRowPolicyRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): DropRowPolicyRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): DropRowPolicyRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): DropRowPolicyRequest = copy(collectionName = __v)
    def withPolicyName(__v: _root_.scala.Predef.String): DropRowPolicyRequest = copy(policyName = __v)
    ...
    def companion: io.milvus.grpc.milvus.DropRowPolicyRequest.type = io.milvus.grpc.milvus.DropRowPolicyRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.DropRowPolicyRequest])
}

object DropRowPolicyRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropRowPolicyRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropRowPolicyRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.DropRowPolicyRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.DropRowPolicyRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(197)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(197)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.DropRowPolicyRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = "",
    policyName = ""
  )
  implicit class DropRowPolicyRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.DropRowPolicyRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.DropRowPolicyRequest](_l) {
  ...
  def of(
    ...
    collectionName: _root_.scala.Predef.String,
    policyName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.DropRowPolicyRequest = _root_.io.milvus.grpc.milvus.DropRowPolicyRequest(
    base,
    dbName,
    collectionName,
    policyName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.DropRowPolicyRequest])
}
