...
final case class CreatePartitionRequest(
    ...
    def companion: io.milvus.grpc.milvus.CreatePartitionRequest.type = io.milvus.grpc.milvus.CreatePartitionRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.CreatePartitionRequest])
}

object CreatePartitionRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.CreatePartitionRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.CreatePartitionRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.CreatePartitionRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.CreatePartitionRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(26)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(26)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.CreatePartitionRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = "",
    partitionName = ""
  )
  implicit class CreatePartitionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.CreatePartitionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.CreatePartitionRequest](_l) {
  ...
  def of(
    ...
    collectionName: _root_.scala.Predef.String,
    partitionName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.CreatePartitionRequest = _root_.io.milvus.grpc.milvus.CreatePartitionRequest(
    base,
    dbName,
    collectionName,
    partitionName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.CreatePartitionRequest])
}
