...
/** *
  ...
  */
@SerialVersionUID(0L)
final case class HasCollectionRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[HasCollectionRequest] {
    @transient
    ...
    def clearBase: HasCollectionRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): HasCollectionRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): HasCollectionRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): HasCollectionRequest = copy(collectionName = __v)
    def withTimeStamp(__v: _root_.scala.Long): HasCollectionRequest = copy(timeStamp = __v)
    ...
    def companion: io.milvus.grpc.milvus.HasCollectionRequest.type = io.milvus.grpc.milvus.HasCollectionRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.HasCollectionRequest])
}

object HasCollectionRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.HasCollectionRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.HasCollectionRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.HasCollectionRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.HasCollectionRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(11)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(11)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.HasCollectionRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = "",
    timeStamp = 0L
  )
  implicit class HasCollectionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.HasCollectionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.HasCollectionRequest](_l) {
  ...
  final val TIME_STAMP_FIELD_NUMBER = 4
  def of(
    base: _root_.scala.Option[io.milvus.grpc.common.MsgBase],
    dbName: _root_.scala.Predef.String,
    collectionName: _root_.scala.Predef.String,
    timeStamp: _root_.scala.Long
  ): _root_.io.milvus.grpc.milvus.HasCollectionRequest = _root_.io.milvus.grpc.milvus.HasCollectionRequest(
    base,
    dbName,
    collectionName,
    timeStamp
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.HasCollectionRequest])
}
