...
/**
  ...
  */
@SerialVersionUID(0L)
final case class GetPartitionStatisticsRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetPartitionStatisticsRequest] {
    @transient
    ...
    def clearBase: GetPartitionStatisticsRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): GetPartitionStatisticsRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): GetPartitionStatisticsRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): GetPartitionStatisticsRequest = copy(collectionName = __v)
    def withPartitionName(__v: _root_.scala.Predef.String): GetPartitionStatisticsRequest = copy(partitionName = __v)
    ...
    def companion: io.milvus.grpc.milvus.GetPartitionStatisticsRequest.type = io.milvus.grpc.milvus.GetPartitionStatisticsRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.GetPartitionStatisticsRequest])
}

object GetPartitionStatisticsRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetPartitionStatisticsRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetPartitionStatisticsRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.GetPartitionStatisticsRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.GetPartitionStatisticsRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(31)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(31)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.GetPartitionStatisticsRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = "",
    partitionName = ""
  )
  implicit class GetPartitionStatisticsRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.GetPartitionStatisticsRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.GetPartitionStatisticsRequest](_l) {
  ...
  def of(
    ...
    collectionName: _root_.scala.Predef.String,
    partitionName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.GetPartitionStatisticsRequest = _root_.io.milvus.grpc.milvus.GetPartitionStatisticsRequest(
    base,
    dbName,
    collectionName,
    partitionName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.GetPartitionStatisticsRequest])
}
