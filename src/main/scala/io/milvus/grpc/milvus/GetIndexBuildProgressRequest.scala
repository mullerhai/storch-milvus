...
/**
  ...
  */
@SerialVersionUID(0L)
final case class GetIndexBuildProgressRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetIndexBuildProgressRequest] {
    @transient
    ...
    def clearBase: GetIndexBuildProgressRequest = copy(base = _root_.scala.None)
    def withBase(__v: io.milvus.grpc.common.MsgBase): GetIndexBuildProgressRequest = copy(base = Option(__v))
    def withDbName(__v: _root_.scala.Predef.String): GetIndexBuildProgressRequest = copy(dbName = __v)
    def withCollectionName(__v: _root_.scala.Predef.String): GetIndexBuildProgressRequest = copy(collectionName = __v)
    def withFieldName(__v: _root_.scala.Predef.String): GetIndexBuildProgressRequest = copy(fieldName = __v)
    def withIndexName(__v: _root_.scala.Predef.String): GetIndexBuildProgressRequest = copy(indexName = __v)
    ...
    def companion: io.milvus.grpc.milvus.GetIndexBuildProgressRequest.type = io.milvus.grpc.milvus.GetIndexBuildProgressRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.GetIndexBuildProgressRequest])
}

object GetIndexBuildProgressRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetIndexBuildProgressRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.GetIndexBuildProgressRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.GetIndexBuildProgressRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.GetIndexBuildProgressRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(44)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(44)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.GetIndexBuildProgressRequest(
  ...
  implicit class GetIndexBuildProgressRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.GetIndexBuildProgressRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.GetIndexBuildProgressRequest](_l) {
  ...
  def of(
    ...
    fieldName: _root_.scala.Predef.String,
    indexName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.GetIndexBuildProgressRequest = _root_.io.milvus.grpc.milvus.GetIndexBuildProgressRequest(
    base,
    dbName,
    collectionName,
    fieldName,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.GetIndexBuildProgressRequest])
}
