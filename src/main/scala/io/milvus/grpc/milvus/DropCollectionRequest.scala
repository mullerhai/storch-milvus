...
final case class DropCollectionRequest(
    ...
    def companion: io.milvus.grpc.milvus.DropCollectionRequest.type = io.milvus.grpc.milvus.DropCollectionRequest
    // @@protoc_insertion_point(GeneratedMessage[milvus.proto.milvus.DropCollectionRequest])
}

object DropCollectionRequest extends scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropCollectionRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.milvus.grpc.milvus.DropCollectionRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.milvus.grpc.milvus.DropCollectionRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.milvus.grpc.milvus.DropCollectionRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.javaDescriptor.getMessageTypes().get(8)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.milvus.grpc.milvus.MilvusProto.scalaDescriptor.messages(8)
  ...
  lazy val defaultInstance = io.milvus.grpc.milvus.DropCollectionRequest(
    base = _root_.scala.None,
    dbName = "",
    collectionName = ""
  )
  implicit class DropCollectionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.milvus.grpc.milvus.DropCollectionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.milvus.grpc.milvus.DropCollectionRequest](_l) {
  ...
  def of(
    ...
    dbName: _root_.scala.Predef.String,
    collectionName: _root_.scala.Predef.String
  ): _root_.io.milvus.grpc.milvus.DropCollectionRequest = _root_.io.milvus.grpc.milvus.DropCollectionRequest(
    base,
    dbName,
    collectionName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[milvus.proto.milvus.DropCollectionRequest])
}
